...
document.querySelector("#overlay1").addEventListener("mousemove",function(dets){
    ...
    document.querySelector("#elem1 img").style.left = (dets.x-305)+"px"
    document.querySelector("#elem1 img").style.top = (dets.y-305)+"px"
})
...
document.querySelector("#overlay2").addEventListener("mousemove",function(dets){
    ...
    document.querySelector("#elem2 img").style.left = (dets.x-650)+"px"
    document.querySelector("#elem2 img").style.top = (dets.y-305)+"px"
})
...
document.querySelector("#overlay3").addEventListener("mousemove",function(dets){
    ...
    document.querySelector("#elem3 img").style.left = (dets.x-1005)+"px"
    document.querySelector("#elem3 img").style.top = (dets.y-305)+"px"
})
